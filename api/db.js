...
const connection = mysql.createConnection({
    ...
    user: 'root',
    password: '',
    database: 'chamaleakhai0027_cdtt'
});
...
app.get('/api/products', (req, res) => {
    const query = 'SELECT * FROM cmlk_product';
...
app.get('/api/products/:id', (req, res) => {
    ...
    const query = 'SELECT * FROM cmlk_product WHERE id = ?';
...
app.put('/api/products/:id', (req, res) => {
    ...
    const query = 'UPDATE cmlk_product SET details = ? WHERE id = ?';
